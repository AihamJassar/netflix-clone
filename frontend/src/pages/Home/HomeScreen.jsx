        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-lg">
              ...
              cupiditate ratione laborum consequatur molestiae at odit mollitia
              eius laudantium debitis labore aliquam sapiente,
            </p>
          </div>
          <div className="flex mt-8">
            <Link
              to={"/watch/123"}
              className="bg-white hover:bg-white/80 text-black font-bold py-2 px-4 mr-4 rounded flex items-center"
            >
